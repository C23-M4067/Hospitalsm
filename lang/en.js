...
export const transMailBookingNew = {
    subject: "Email notification of booking progress at HospitalSM",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at HospitalSM's system </h3>
        ...
        <h4>HospitalSM system will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
    },
};
...
export const transMailRemedy= {
    ...
    template: (data) => {
        return `<h3>Thank you for your trust in booking a medical examination in HospitalSM system.</h3>
        ...
        <br>
        <div>For example: Full name: patient, with the registered phone number: 0123456789 and born: 1910, the extracted password is: <b> hospital123 </b> </div>
        <br>
