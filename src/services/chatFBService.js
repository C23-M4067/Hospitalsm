...
//                     let text = `HELLO ${username}. I'm a chat bot to support hospitalSM. What help do you need?`;
...
//                     break;
//                 case "BACK":
//                     await sendMessageDefault(sender_psid, "View more information:")
//                     break;
//                 case "yes":
//                     response = "Thanks!";
...
//         await callSendAPI(sender_psid, "Thank you for using the services of HospitalSM !!!");
//         return;
//     }
...
//                 await callSendAPI(sender_psid, "If you are looking for information about doctors, see more at the link below.");
//                 let title = "HospitalSM";
//                 let subtitle = 'Information about doctors working at HospitalSM';
//                 await callSendAPIv2(sender_psid, title, subtitle, DOCTOR_IMAGE_URL, DOCTOR_URL);
//                 await sendMessageDefault(sender_psid, "View more information:");
//             }
//             if (entity.value === 'Digest') {
//                 await callSendAPI(sender_psid, "You are having problems with gastrointestinal diseases, see also the list of gastroenterologists.");
//                 let title = "Medical specialty";
//                 let subtitle = 'Information about a gastroenterologist';
//                 await callSendAPIv2(sender_psid, title, subtitle, TIEUHOA_IMAGE_URL, TIEUHOA_URL);
//                 await sendMessageDefault(sender_psid, "View more information:");
//             }
//             if (entity.value === 'Business') {
//                 await callSendAPI(sender_psid, "You are having mechanical problems, see the list of musculoskeletal specialists. ");
//                 Let Title = "Specialist examination";
//                 let subtitle = 'Information specialist in mechanicsp';
//                 await callSendAPIv2(sender_psid, title, subtitle, COXUONGKHOP_IMAGE_URL, COXUONGKHOP_URL);
//                 await sendMessageDefault(sender_psid, "View more information:");
//             }
//             break;
//         case"booking":
//             await callSendAPI(sender_psid, "You are looking for a medical examination, see more detailed schedules in the link below.");
//             await callSendAPIv2(sender_psid, "Schedule "," Instructions for booking examination at Doctors Care", BOOKING_IMAGE_URL, BOOKING_URL);
//             await sendMessageDefault(sender_psid, "View more information:");
//             break;
//         case"info":
...
//                                 "image_url": "/images/users/doctor.jpg",
...
//                                 "image_url": "/images/users/doctor-hoang-dinh-tung.jpg",
...
//                                 "image_url": "/images/users/doctor-eric-pham.jpg",
...
//                             {
//                                 "title": "TAI MŨI HỌNG",
//                                 "image_url": "/images/specializations/tai-mui-hong.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/specialization/1",
//                                     "webview_height_ratio": "tall"
//                                 }
//                             },
...
//                             {
//                                 "title": "THẦN KINH",
//                                 "image_url": "/images/specializations/than-kinh.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/specialization/2",
//                                     "webview_height_ratio": "tall"
//                                 }
//                             },
//                             {
//                                 "title": "TIÊU HÓA",
//                                 "image_url": "/images/specializations/tieu-hoa.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/specialization/3",
//                                     "webview_height_ratio": "tall"
//                                 }
//                             },
...
//                                 "image_url": "/images/clinics/phong-kham-thu-cuc.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/clinic/1",
//                                     "webview_height_ratio": "tall"
...
//                                 "image_url": "/images/clinics/phong-kham-meditec.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/clinic/2",
//                                     "webview_height_ratio": "tall"
...
//                                 "image_url": "/images/clinics/phong-kham-bao-son.jpg",
//                                 "default_action": {
//                                     "type": "web_url",
//                                     "url": "/detail/clinic/3",
//                                     "webview_height_ratio": "tall"
...
//             await sendMessageDefault(user.psid, "View more information:");
//             resolve("done");
//         } catch (e) {
//             reject(e);
//         }
